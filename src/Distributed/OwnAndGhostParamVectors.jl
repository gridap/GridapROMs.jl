...
function ParamDataStructures.parameterise(a::OwnAndGhostVectors,plength::Integer)
  own_values = parameterise(a.own_values,plength)
  ghost_values = parameterise(a.ghost_values,plength)
