...
println("=== AUTO-NOMAD TRANSIENT TEST (2D HEAT EQUATION) ===")

# ===================================================================
# 1. PHYSICS & FEM SETUP
# ===================================================================
domain = (0.0, 1.0, 0.0, 1.0)
partition = (10, 10) # Medium grid
...
p_train = realisation(D_p; nparams=10, sampling=:uniform)
p_test  = realisation(D_p; nparams=3,  sampling=:uniform)
...
# 3. AUTO-NOMAD SETUP
# ===================================================================
# We use AutoNOMAD to dynamically infer the input layer size.
# For this problem: 1 parameter + (2 spatial coords + 1 time) = 4 inputs total.
...
# ===================================================================
println("\nTraining Transient AutoNOMAD (Offline Phase)...")
